...
In truth, this power may stem from an ancient machine buried deep within the planet’s core—still active, still radiating its influence—or perhaps the planet itself was forever changed by the Ancients’ passing, infused with a power that now fuels the arcane.

Spellcasters may interpret and interact with magic in different ways, depending on their nature and origin. Here are some common examples:
- **Wizards** harness magic through study and discipline, learning to access and manipulate its flow through rigorous training and understanding.
- **Sorcerers** are born with an innate connection to magic, instinctively knowing the gestures, words, and focus required to cast spells without formal education.
- **Warlocks** gain magical power through contact with powerful entities—either by forging pacts or being altered by proximity to raw cosmic force—channeling spells through that bond.
- **Bards** weave magic into their performance, channeling spells through music, speech, movement, and storytelling, turning expression into arcane influence.
